...
public final class NTLM {
    ...
    private Cipher getCipher(byte[] key) throws Exception {
        try {
            ...
            throw new Exception("DES encryption is not available.");
        } catch (InvalidKeyException e) {
            throw new Exception("Invalid key for DES encryption.");
    ...
    private byte[] encrypt(byte[] key, byte[] bytes)
        ...
        try {
            ...
            throw new Exception("Invalid block size for DES encryption.");
